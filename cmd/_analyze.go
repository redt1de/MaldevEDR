...
var analyzeCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		dSess, err := dbgproc.NewDebugProcess(spawn, spawnEnv, true)
...
func init() {
	...
	analyzeCmd.Flags().StringP("spawn", "s", "", "cmdline to spawn a process, will use -f if not set")
	analyzeCmd.Flags().StringP("spawn-env", "e", "", "environment vars for spawned a process")
